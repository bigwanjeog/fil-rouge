...
DROP PROCEDURE RESET_SEQ_PROJET;
DROP FUNCTION DATE_ANNEE;
DROP TRIGGER TRIGGER_PROJET_ID;
DROP TRIGGER TRIGGER_CLIENT_ID;
DROP TRIGGER TRIGGER_ACTIVITE_ID;
DROP TRIGGER TRIGGER_COLLABORATEUR_ID;
DROP TRIGGER TRIGGER_CONTACT_ID;
DROP TRIGGER TRIGGER_DOCUMENT_ID;
DROP TRIGGER TRIGGER_ETAPE_PROJET_ID;
DROP TRIGGER TRIGGER_FONCTION_ID;
DROP TRIGGER TRIGGER_INTERVENTION_ID;
DROP TRIGGER TRIGGER_NATURE_CLIENT_ID;
DROP TRIGGER TRIGGER_SALAIRE_ID;
DROP TRIGGER TRIGGER_TECHNOLOGIE_ID;
DROP TRIGGER TRIGGER_TYPE_TECHNO_ID;
DROP TRIGGER TRIGGER_TYPE_PROJET_ID;
DROP TRIGGER TRIGGER_ETAPE_ID;
*/
...
CREATE SEQUENCE SEQ_PROJET_ID START WITH 1 MAXVALUE 99;
CREATE SEQUENCE SEQ_ETAPE_ID START WITH 1 MAXVALUE 99;
...
EXECUTE IMMEDIATE'CREATE SEQUENCE SEQ_PROJET_ID START WITH 1 MAXVALUE 99';
EXECUTE IMMEDIATE'CREATE SEQUENCE SEQ_ETAPE_ID START WITH 1 MAXVALUE 99';
